...
class TestReview(FrappeTestCase):
    ...
    def test_review_id_generation(self):
        ...
        from tr_tradehub.doctype.review.review import Review
    ...
    def test_api_create_review(self):
        ...
        from tr_tradehub.doctype.review.review import check_review_eligibility
    ...
    def test_api_get_review_statistics(self):
        ...
        from tr_tradehub.doctype.review.review import get_review_statistics
