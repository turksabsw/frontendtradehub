...
class TestSellerProfile(FrappeTestCase):
    ...
    def test_vkn_validation_valid(self):
        ...
        from tr_tradehub.doctype.seller_profile.seller_profile import SellerProfile
...
class TestSellerProfileAPI(FrappeTestCase):
    ...
    def test_validate_tckn_api(self):
        ...
        from tr_tradehub.doctype.seller_profile.seller_profile import validate_tax_id
    ...
    def test_validate_iban_api(self):
        ...
        from tr_tradehub.doctype.seller_profile.seller_profile import validate_iban
