...
class PIMProduct(Document):
    ...
    def update_completeness(self):
        ...
        from tr_tradehub.pim.completeness import calculate_completeness
    ...
    def sync_to_erpnext(self, create_if_missing=True, include_variants=False):
        ...
        """
        from tr_tradehub.pim.erpnext_sync import sync_product_to_item, sync_product_variants_to_items
