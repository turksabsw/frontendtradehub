...
class TestTrackingEventHelperFunctions(unittest.TestCase):
    ...
    def test_get_shipment_tracking_history(self):
        ...
        from tr_tradehub.doctype.tracking_event.tracking_event import (
            log_tracking_event,
    ...
    def test_map_carrier_event_type(self):
        ...
        from tr_tradehub.doctype.tracking_event.tracking_event import map_carrier_event_type
...
class TestTrackingEventAPI(unittest.TestCase):
    ...
    def test_create_tracking_event_api(self):
        ...
        from tr_tradehub.doctype.tracking_event.tracking_event import create_tracking_event
