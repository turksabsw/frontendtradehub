...
class TestOrderEventHelperFunctions(FrappeTestCase):
    ...
    def setUpClass(cls):
        ...
        from tr_tradehub.doctype.order_event.order_event import (
            log_order_event,
            log_status_change,
            log_error_event
        )
...
class TestOrderEventAPI(FrappeTestCase):
    ...
    def test_get_order_events_api(self):
        ...
        from tr_tradehub.doctype.order_event.order_event import get_order_events
    ...
    def test_get_order_timeline_api(self):
        ...
        from tr_tradehub.doctype.order_event.order_event import get_order_timeline
    ...
    def test_get_event_statistics_api(self):
        ...
        from tr_tradehub.doctype.order_event.order_event import get_event_statistics
    ...
    def test_create_order_event_api(self):
        ...
        from tr_tradehub.doctype.order_event.order_event import create_order_event
