...
class MarketplaceOrder(Document):
    ...
    def create_erpnext_sales_order(self):
        ...
        Uses centralized sync utilities from tr_tradehub.utils.erpnext_sync
    ...
    def get_or_create_erpnext_customer(self):
        ...
        from tr_tradehub.utils.erpnext_sync import _get_or_create_customer_for_order
    ...
    def get_default_warehouse(self):
        ...
        # Import the helper function from sync utilities
        from tr_tradehub.utils.erpnext_sync import _get_default_warehouse
