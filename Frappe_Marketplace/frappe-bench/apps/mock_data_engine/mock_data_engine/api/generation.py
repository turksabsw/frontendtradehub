...
Usage:
    ...
    result = frappe.call(
        'mock_data_engine.api.generation.generate',
        doctype='Customer',
        count=10,
        locale='tr_TR'
    )
    ...
    result = frappe.call(
        'mock_data_engine.api.generation.generate_async',
        doctype='Customer',
        count=1000,
        locale='tr_TR'
    )
    ...
    progress = frappe.call(
        'mock_data_engine.api.generation.get_progress',
        request_name='MGR-2024-00001'
    )

    # Test LLM connection
    result = frappe.call(
        'mock_data_engine.api.generation.test_llm_connection',
        provider='gemini'
    )
"""
